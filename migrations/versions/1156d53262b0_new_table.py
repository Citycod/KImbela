...
def upgrade():
    ...
    if dialect == "sqlite":
        ...
        if _sqlite_table_exists(conn, "notifications"):
            op.create_index(
                "ix_notification_created", "notifications", ["created_at"], unique=False
            )
            op.create_index(
        ...
        if _sqlite_table_exists(conn, "user_blocks"):
            with op.batch_alter_table("user_blocks", schema=None) as batch_op:
                batch_op.create_unique_constraint(
                    "uq_user_block", ["blocker_id", "blocked_id"]
                )
    ...
    with op.batch_alter_table("messages", schema=None) as batch_op:
        ...
        batch_op.drop_index(
            "ix_messages_unread", postgresql_where="((status)::text = 'sent'::text)"
        )
    ...
    with op.batch_alter_table("notifications", schema=None) as batch_op:
        ...
        batch_op.drop_index(
            "ix_notifications_user_read", postgresql_where="(is_read = false)"
        )
    ...
    with op.batch_alter_table("posts", schema=None) as batch_op:
        ...
        batch_op.drop_index(
            "ix_posts_group_created", postgresql_where="(group_id IS NOT NULL)"
        )
        batch_op.create_index("idx_post_author", ["author_id"], unique=False)
        batch_op.create_index(
            "idx_post_author_created", ["author_id", "created_at"], unique=False
        )
...
def downgrade():
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        batch_op.create_index(
            "ix_users_last_seen", [sa.text("last_seen DESC")], unique=False
        )
    ...
    with op.batch_alter_table("reactions", schema=None) as batch_op:
        batch_op.create_index(
            "ix_reactions_post_user", ["post_id", "user_id"], unique=False
        )
    ...
    with op.batch_alter_table("posts", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_posts_created_desc", [sa.text("created_at DESC")], unique=False
        )
        batch_op.create_index(
            "ix_posts_author_created",
        ...
        batch_op.create_index(
            "idx_posts_content_trgm", ["content"], unique=False, postgresql_using="gin"
        )
    ...
    with op.batch_alter_table("notifications", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_notifications_entity", ["entity_type", "entity_id"], unique=False
        )
        batch_op.create_index(
            "idx_notifications_user_read_created",
    ...
    with op.batch_alter_table("marketplace_services", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_marketplace_services_seller", ["seller_id", "status"], unique=False
        )
        batch_op.create_index(
            "ix_marketplace_services_category",
        ...
        batch_op.create_index(
            "idx_services_title_trgm", ["title"], unique=False, postgresql_using="gin"
        )
        batch_op.create_index(
            "idx_services_description_trgm",
            ["description"],
    ...
    with op.batch_alter_table("groups", schema=None) as batch_op:
        batch_op.create_index(
            "ix_groups_active",
            ["is_active", sa.text("member_count DESC")],
            unique=False,
        )
    ...
    with op.batch_alter_table("comments", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "idx_comment_post_created", ["post_id", "created_at"], unique=False
        )
        ...
        batch_op.create_index(
            "idx_comment_author_post", ["author_id", "post_id"], unique=False
        )
