...
def downgrade():
    ...
    with op.batch_alter_table('like', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('like_post_id_fkey'), 'posts', ['post_id'], ['id'], ondelete='CASCADE')

    with op.batch_alter_table('comment', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('comment_post_id_fkey'), 'posts', ['post_id'], ['id'], ondelete='CASCADE')
