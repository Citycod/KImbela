...
Revision ID: 1dddcb7b0b21
Revises: e6b627359ec7
Create Date: 2025-11-25 13:15:41.043869
...
revision = '1dddcb7b0b21'
down_revision = 'e6b627359ec7'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('email_token', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('email_token_expires', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    ...
    sa.UniqueConstraint('email_token', name=op.f('user_email_token_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
