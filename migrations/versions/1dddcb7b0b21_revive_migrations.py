...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "country", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        ...
        sa.Column(
            "email_token", sa.VARCHAR(length=100), autoincrement=False, nullable=True
        ),
        sa.Column(
            "email_token_expires",
        ...
        sa.UniqueConstraint(
            "email_token",
            name=op.f("user_email_token_key"),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
