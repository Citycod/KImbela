...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['package_id'], ['ad_packages.id'], ),
    ...
    with op.batch_alter_table('reactions', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('reactions_post_id_fkey'), type_='foreignkey')
        batch_op.drop_constraint(batch_op.f('reactions_user_id_fkey'), type_='foreignkey')
...
def downgrade():
    ...
    with op.batch_alter_table('reactions', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('reactions_user_id_fkey'), 'users', ['user_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('reactions_post_id_fkey'), 'posts', ['post_id'], ['id'])
