...
def test_homepage_navbar_ends_with_one_standard_install_link(client):
    ...
    assert "homepage-install-nav" not in navbar
    assert navbar.rfind("Install Kimbela") > navbar.rfind("Login")
