def create_flutterwave_transaction(self, user, campaign, amount, currency, request_id=None):
    ...
    try:
        ...
        payment_data = {
            ...
            "customizations": {
                ...
                "description": f"Matchmaking Request" if request_id else f"Ad Campaign: {campaign.title}",
        ...
        if response.status_code == 200:
            ...
            if result.get('status') == 'success':
                ...
                payment = PaymentTransaction(
                    user_id=user.id,
                    campaign_id=request_id if request_id else (campaign.id if campaign else None),
                    amount=amount,
                    currency=currency,
